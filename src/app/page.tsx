...
export default function Home() {
  return <>
      <main className="flex justify-center gap-10 h-9/10 max-h-[900] p-10 ">
          <CompanyCard/>
          <EmailCard/>
          <DataTable/>
      </main>
      <CombToaster/>
      <nav className="h-fit max-w-2xl mx-auto flex py-2 px-4 rounded-sm border w-full bg-card items-center justify-between">
